<?php
/*
 * Template Name: Domokomplect page
 */
$all_summ = 0;
$prod_count = array();
...
<div class="main catalog_single_page domkomplect">
	<div class="container">
										...
										<div class="price_wrap">
											<div class="price">
												<label>
													...
													<span class="price_title"><?php the_field('price_title_1')?> <span>от <span class="sum_price"><?php echo !empty(get_field('price_natural_1')) ? the_field('price_natural_1') : 0;?></span> руб.</span></span>
												</label>
											</div>
											<div class="price">
												<label>
	    ...
	    <div class="modal_body">
	      <div class="form">
	        ...
	        <div class="form_product_info">
	        	...
	        	<div class="form_product_info_sum">На сумму: <span><?php echo $all_summ;?></span> руб.</div>
	        </div>
