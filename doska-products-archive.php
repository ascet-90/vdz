<?php
/*
 * Template Name: Doska Level 2 Archive page
 */
get_header();
?>

<div class="main catalog_archive_page doska_archive doska_products_archive">
	<div class="container">
			...
			<div class="content">
				<?php if(have_posts()):
					while(have_posts()):the_post();?>
						...
						<?php	
							$pages = get_posts(array('post_type' => 'page', 'post_parent' => get_the_ID(), 'numberposts' => -1));		
							if(isset($_GET['meta_key']) && $_GET['meta_key'] == 'price' && $_GET['order'] == 'DESC') {
								$pages = get_posts(array('post_type' => 'page', 'post_parent' => get_the_ID(), 'meta_key' => 'price','orderby' => 'meta_value_num', 'order' => 'desc', 'numberposts' => -1));
							}
							elseif (isset($_GET['meta_key']) && $_GET['meta_key'] == 'price' && $_GET['order'] == 'ASC') {
								$pages = get_posts(array('post_type' => 'page', 'post_parent' => get_the_ID(), 'meta_key' => 'price','orderby' => 'meta_value_num', 'order' => 'asc', 'numberposts' => -1));
							}?>
